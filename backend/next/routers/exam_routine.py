...
# Set up logging to help you see errors in your Render logs
logger = logging.getLogger("uvicorn.error")

# Remove the trailing slash from prefix to avoid routing conflicts
router = APIRouter(prefix="/api/routines", tags=["Exam Routines"])

@router.get("") # Removed the slash here
...
# Safe conversion to list of dicts
...
# Standardize columns to match required format
